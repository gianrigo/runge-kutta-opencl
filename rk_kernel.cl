...
float opencl_distance(vector x, vector y);
...
__kernel void rk2_kernel(__global vector *v0, int count_v0, float h, int n_x, int n_y, int n_z, vector_field field,__global vector *points,__global int *n_points, int max_points){
